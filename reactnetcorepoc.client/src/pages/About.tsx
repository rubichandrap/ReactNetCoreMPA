    ...
    <div>
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <div className="bg-white border-4 border-black shadow-neubrutalism p-8 mb-8 text-center">
          <h1 className="text-3xl font-black text-black mb-4">About ReactNetCorePOC</h1>
          <p className="text-lg font-semibold text-black">Building modern web applications with React and .NET Core</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div className="bg-white border-4 border-black shadow-neubrutalism p-6 hover:shadow-neubrutalism-lg transition-all duration-200">
            <h3 className="text-xl font-bold text-black mb-4">Our Technology Stack</h3>
          ...
          <div className="bg-white border-4 border-black shadow-neubrutalism p-6 hover:shadow-neubrutalism-lg transition-all duration-200">
            <h3 className="text-xl font-bold text-black mb-4">Why MPA?</h3>
        ...
        <div className="bg-neubrutalism-pink border-4 border-black shadow-neubrutalism p-8 text-center text-white">
          ...
          <p className="text-lg mb-6">Experience the power of modern web development with our React + .NET Core stack.</p>
