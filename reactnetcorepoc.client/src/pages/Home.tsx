    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-neubrutalism-yellow to-neubrutalism-pink border-b-4 border-black py-20 text-center">
        <div className="container mx-auto px-6">
          <h1 className="text-6xl font-black text-black mb-6">Welcome to ReactNetCorePOC</h1>
          <p className="text-2xl font-semibold text-black mb-8">A modern React + .NET Core application with neubrutalism design and SEO-friendly server-side rendering</p>
      ...
      <main className="container mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-white border-4 border-black shadow-neubrutalism p-8 hover:shadow-neubrutalism-lg transition-all duration-200">
            <h3 className="text-2xl font-bold text-black mb-4">🚀 Server-Side Rendering</h3>
          ...
          <div className="bg-white border-4 border-black shadow-neubrutalism p-8 hover:shadow-neubrutalism-lg transition-all duration-200">
            <h3 className="text-2xl font-bold text-black mb-4">⚡ React Interactivity</h3>
            <p className="text-black">Rich client-side interactivity powered by React components with Tailwind CSS for modern styling.</p>
          </div>
          
          <div className="bg-white border-4 border-black shadow-neubrutalism p-8 hover:shadow-neubrutalism-lg transition-all duration-200">
            <h3 className="text-2xl font-bold text-black mb-4">🔧 .NET Core API</h3>
          ...
          <div className="bg-white border-4 border-black shadow-neubrutalism p-8 hover:shadow-neubrutalism-lg transition-all duration-200">
            <h3 className="text-2xl font-bold text-black mb-4">📱 Responsive Layout</h3>
            <p className="text-black">Mobile-first design that works perfectly on all devices with modern CSS Grid and Flexbox.</p>
          </div>
          
          <div className="bg-white border-4 border-black shadow-neubrutalism p-8 hover:shadow-neubrutalism-lg transition-all duration-200">
            <h3 className="text-2xl font-bold text-black mb-4">🔐 Secure Authentication</h3>
        ...
        <div className="bg-white border-4 border-black shadow-neubrutalism p-8 mb-8">
          <h2 className="text-3xl font-bold text-center mb-8 text-black">Interactive React Components</h2>
          
          {/* Counter Component */}
          <div className="bg-neubrutalism-yellow border-4 border-black shadow-neubrutalism-sm p-6 mb-6">
            <h3 className="text-xl font-bold mb-4 text-black">Counter Component</h3>
            <button 
          ...
          {weatherData && (
            <div className="bg-neubrutalism-blue border-4 border-black shadow-neubrutalism-sm p-6">
              <h3 className="text-xl font-bold mb-4 text-black">Weather Forecast</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {weatherData.slice(0, 3).map((forecast: WeatherForecast, index: number) => (
                  <div key={index} className="bg-white border-4 border-black shadow-neubrutalism-sm p-4 text-center">
                    ...
                    <div className="text-2xl font-bold text-neubrutalism-pink">{forecast.temperatureC}°C</div>
